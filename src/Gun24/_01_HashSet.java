...
public class _01_HashSet {
    public static void main(String[] args) {
        ...
        // yani 1 elemandan sadece 1 tane olan diziler lazım.  hangi sırada olduğunun bir önemi yoktur.
        ...
        hs1.add(4);
        hs1.add(5);
        boolean eklendMi=hs1.add(5);

        System.out.println("eklendMi = " + eklendMi);
